            ...
            <div class="form-edit">
                <form action="produk/aksi_edit.php" method="post">
                    <?php while ($edit_data_produk = mysqli_fetch_array($edit_ini)) { ?>
                        ...
                        <input type="text" name="edit_nama" id="edit_nama" value="<?php echo $edit_data_produk['nama_produk']; ?>"><br><br>
                        <label for="edit_harga">Harga Produk</label><br>
                        <input type="number" name="edit_harga" id="edit_harga" value="<?php echo $edit_data_produk['harga']; ?>"><br><br>
